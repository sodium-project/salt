if(NOT DEFINED SALT_DEBUG_CONTAINER_NODE_SIZES)
    set(SALT_DEBUG_CONTAINER_NODE_SIZES OFF)
endif()

function(salt_debug_message)
    if(SALT_DEBUG_CONTAINER_NODE_SIZES)
        message("${ARGV}")
    endif()
endfunction()
...
function(salt_get_type_alignments _TYPE _OUT)
    file(WRITE "${CMAKE_BINARY_DIR}/generated/containers_node_size/align_of.cpp"
    [[#include <cstddef>
...
get_align_of<TEST_TYPE> alignment;
    ...
    try_compile(
        ...
        ${CMAKE_BINARY_DIR}
        ${CMAKE_BINARY_DIR}/generated/containers_node_size/align_of.cpp
...
# This function is used by `salt_configure_containers_node_size`. Don't call it
# unless you know what you are doing.
function(salt_configure_containers_node_size_hpp _HEADER_OUT)
    set(_HEADER ${CMAKE_BINARY_DIR}/generated/containers_node_size/containers_node_size_impl.hpp.in)
...
# This function is used by `salt_get_container_node_size`. Don't call it
# unless you know what you are doing.
function(salt_configure_containers_node_size_cpp _SOURCE_OUT)
    set(_SOURCE ${CMAKE_BINARY_DIR}/generated/containers_node_size/containers_node_size_impl.cpp)
...
function(salt_get_container_node_size _CONTAINER _TYPES _ALIGNMENTS_OUT _NODE_SIZES_OUT)
    ...
    foreach(TYPE IN LISTS _TYPES)
        salt_configure_containers_node_size_cpp(_CONTAINERS_NODE_SIZE_SOURCE_PATH)
...
")
    ...
    configure_file("${_CONTAINERS_NODE_SIZE_HEADER_PATH}" ${_FILE_OUT})
endfunction()
