...
TEST_CASE("salt::fdn::detail::free_list", "[salt-foundation/free_list.hpp]") {
    SECTION("construct") {
...
TEST_CASE("salt::fdn::detail::ordered_free_list", "[salt-foundation/free_list.hpp]") {
    SECTION("construct") {
    ...
    SECTION("move") {
        ...
        static_allocator_storage<1024> new_memory;
        detail::ordered_free_list new_list(std::move(list));
        check_list(new_list, &new_memory, 1024);
