...
TEST_CASE("salt::fdn::detail::debug_fill", "[salt-foundation/debug_helpers.hpp]") {
...
TEST_CASE("salt::fdn::detail::debug_is_filled", "[salt-foundation/debug_helpers.hpp]") {
    debug_magic magic_values[10];
    for (auto& magic_value : magic_values)
        magic_value = debug_magic::freed_memory;
...
TEST_CASE("salt::fdn::detail::debug_fill_new/free", "[salt-foundation/debug_helpers.hpp]") {
    debug_magic magic_values[10];
