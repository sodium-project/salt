...
template <typename InputIterator, typename ForwardIterator>
    requires meta::nothrow_move_constructible<std::iter_value_t<ForwardIterator>>
...
constexpr auto uninitialized_relocate(InputIterator   first,
                                      InputIterator   last,
                                      ForwardIterator d_first) noexcept {
    using T = decltype(std::ranges::iter_move(first));
    using U = std::iter_value_t<ForwardIterator>;
    if constexpr (
...
template <typename InputIterator, typename ForwardIterator>
    requires meta::nothrow_move_constructible<std::iter_value_t<InputIterator>>
