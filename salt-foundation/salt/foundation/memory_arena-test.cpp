...
TEST_CASE("salt::fdn::memory_block_stack", "[salt-foundation/memory_arena.hpp]") {
...
TEST_CASE("salt::fdn::detail::memory_arena_cache", "[salt-foundation/memory_arena.hpp]") {
    using memory_block_stack = detail::memory_block_stack;
...
TEST_CASE("salt::fdn::memory_arena_cached", "[salt-foundation/memory_arena.hpp]") {
...
TEST_CASE("salt::fdn::memory_arena_not_cached", "[salt-foundation/memory_arena.hpp]") {
...
TEST_CASE("salt::fdn::make_block_allocator", "[salt-foundation/memory_arena.hpp]") {
...
TEST_CASE("salt::fdn::literals", "[salt-foundation/memory_arena.hpp]") {
