...
TEST_CASE("salt::fdn::align_offset", "[salt-foundation/align.hpp]") {
...
TEST_CASE("salt::fdn::is_aligned", "[salt-foundation/align.hpp]") {
    auto ptr = reinterpret_cast<void*>(0);
...
TEST_CASE("salt::fdn::alignment_for", "[salt-foundation/align.hpp]") {
...
TEST_CASE("salt::fdn::ilog2", "[salt-foundation/align.hpp]") {
...
TEST_CASE("salt::fdn::ilog2_ceil", "[salt-foundation/align.hpp]") {
    SECTION("Check everything up to 2^16") {
        for (std::size_t i = 0; i != 16; ++i) {
            auto power = 1u << i;
