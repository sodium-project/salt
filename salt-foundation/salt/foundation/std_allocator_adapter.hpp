...
#include <salt/foundation/allocator_storage.hpp>
...
class [[nodiscard]] std_allocator_adapter : protected allocator_reference<RawAllocator> {
    ...
    static constexpr bool is_shared_allocator   = fdn::is_shared_allocator  <RawAllocator>::value;
    static constexpr bool is_stateful_allocator = fdn::is_stateful_allocator<RawAllocator>::value;
