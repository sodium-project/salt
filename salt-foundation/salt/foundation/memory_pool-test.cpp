...
TEST_CASE("salt::fdn::memory_pool", "[salt-foundation/memory_pool.hpp]") {
    using memory_pool       = salt::fdn::memory_pool<>;
    using allocator_traits  = salt::fdn::allocator_traits<memory_pool>;
...
TEST_CASE("salt::fdn::memory_pool_array", "[salt-foundation/memory_pool.hpp]") {
    using memory_pool      = salt::fdn::memory_pool<salt::fdn::array_pool>;
...
void use_min_block_size(std::size_t node_size, std::size_t number_of_nodes) {
    using memory_pool = salt::fdn::memory_pool<PoolType>;
...
TEST_CASE("salt::fdn::memory_pool::min_block_size", "[salt-foundation/memory_pool.hpp]") {
    SECTION("node pool") {
        use_min_block_size<salt::fdn::node_pool>(1, 1);
        use_min_block_size<salt::fdn::node_pool>(16, 1);
        use_min_block_size<salt::fdn::node_pool>(1, 1000);
        use_min_block_size<salt::fdn::node_pool>(16, 1000);
    }

    SECTION("array pool") {
        use_min_block_size<salt::fdn::array_pool>(1, 1);
        use_min_block_size<salt::fdn::array_pool>(16, 1);
        use_min_block_size<salt::fdn::array_pool>(1, 1000);
        use_min_block_size<salt::fdn::array_pool>(16, 1000);
    }
}