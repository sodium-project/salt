#include <salt/foundation/containers/static_vector.hpp>

#include <catch2/catch.hpp>

namespace trivially_copyable_vector {

using vector_type = salt::containers::static_vector<int, 5>;
...
using vector_type = salt::containers::static_vector<copyable_or_movable, 5>;
...
using vector_type = salt::containers::static_vector<nontrivial_int, 5>;
...
struct nontrivial_counter {
    ...
    nontrivial_counter& operator=(nontrivial_counter&& other) noexcept {
        ...
        has_resource = salt::utility::exchange(other.has_resource, false);
        return *this;
    }
...
struct complex_type {
    using int_array = salt::containers::array<int, 2>;
...
TEST_CASE("salt::containers::static_vector", "[salt-containers/static_vector.hpp]") {
    using namespace salt;
    using namespace salt::containers;
    ...
    SECTION("move constructor") {
        {
            ...
            constexpr static_vector<nontrivial_int, 3> v2{meta::move(v1)};
    ...
    SECTION("insert range") {
        {
            constexpr auto v1 = []() {
                static_vector<int, 6>     v{1, 2, 3, 4};
                containers::array<int, 3> a{5, 6, 7};
        ...
        }
        {
            constexpr auto v1 = []() {
                static_vector<nontrivial_int, 3>     v;
                containers::array<nontrivial_int, 3> a{0, 1, 2};
    ...
    SECTION("erase range") {
        ...
        {
            constexpr auto v1 = []() {
                static_vector<nontrivial_int, 6>     v{0, 1, 2};
                containers::array<nontrivial_int, 3> a{5, 6, 7};
