...
TEST_CASE("salt::fdn::uninitialized_value_construct",
          "[salt-foundation/uninitialized_construct.hpp]") {
...
TEST_CASE("salt::fdn::uninitialized_value_construct_n",
          "[salt-foundation/uninitialized_construct.hpp]") {
    using namespace salt::fdn;
...
TEST_CASE("salt::fdn::uninitialized_relocate", "[salt-foundation/uninitialized_construct.hpp]") {
    using namespace salt::fdn;
