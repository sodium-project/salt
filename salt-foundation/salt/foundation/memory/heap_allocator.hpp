#pragma once
#include <salt/foundation/memory/detail/low_level_allocator_adapter.hpp>

#if defined(SALT_USE_MIMALLOC)
// TODO:
//  Implement `mimalloc` allocator support.
#elif SALT_TARGET(WINDOWS)
#    include <salt/foundation/memory/detail/win32_heap_allocator.hpp>
...
#else
#    include <salt/foundation/memory/detail/malloc_allocator.hpp>
namespace salt::memory::detail {
