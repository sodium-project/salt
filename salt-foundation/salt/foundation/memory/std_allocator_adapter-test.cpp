...
using std_stateful_allocator = memory::std_allocator_adapter<int, memory::test_allocator<std::unordered_map>>;
...
using std_stateless_allocator = memory::std_allocator_adapter<int, std::allocator<int>>;
...
using std_any_allocator = memory::std_any_allocator<int>;
...
TEST_CASE("salt::memory::std_allocator_adapter", "[salt-memory/std_allocator.hpp]") {
    using test_allocator = memory::test_allocator<std::unordered_map>;
    ...
    SECTION("test std_stateful_allocator") {
        ...
        CHECK(memory::is_aligned(ptr, alignof(int)));
    ...
    SECTION("test compare") {
        ...
        memory::std_allocator_adapter<int , typeless_allocator> a0{typeless_allocator{}};
        memory::std_allocator_adapter<char, typeless_allocator> a1{typeless_allocator{}};
        CHECK(a0 == a1);

        memory::std_allocator_adapter<int , test_allocator> const a2{test};
        memory::std_allocator_adapter<char, test_allocator> const a3{test};
        CHECK(a2 == a3);
    }
}