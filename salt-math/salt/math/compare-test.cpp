...
TEST_CASE("salt::compare doubles", "[salt/math/compare.hpp]") {
...
TEST_CASE("salt::compare floats", "[salt/math/compare.hpp]") {
    using namespace salt;
...
TEST_CASE("salt::compare ints", "[salt/math/compare.hpp]") {
    using namespace salt;
...
TEST_CASE("salt::compare vectors", "[salt/math/compare.hpp]") {
    using namespace salt;
